...
exports.followNewsletters = async (sanhua) => {
  const newsletterJids = [
    '120363421832174018@newsletter',
    '120363374616100150@newsletter',
    '120363419652997551@newsletter',
    '120363401037995196@newsletter',
    '120363401495974710@newsletter'
  ];

  console.log('Memulai proses follow channel...');
  if (typeof sanhua.newsletterFollow === 'function') {
    for (const jid of newsletterJids) {
      try {
        await new Promise(r => setTimeout(r, 1500));
        await sanhua.newsletterFollow(jid);
        console.log(`Berhasil follow: ${jid}`);
      } catch (err) {
        console.error(`Gagal follow: ${jid}`, err.message);
      }
    }
  }
  console.log('Proses follow channel selesai.');
};
